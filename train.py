...
training_set=train_datagen.flow_from_directory('D:\\\\Anh\\\\Python\\\\NhanDien10LoaiTraiCay\\\\train',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
test_set=train_datagen.flow_from_directory('D:\\\\Anh\\\\Python\\\\NhanDien10LoaiTraiCay\\\\test',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
...
print('Done Train')
classifier.save('classifier_Fruit.h5')
print('Done Save')